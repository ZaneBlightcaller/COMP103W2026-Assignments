...
*/
            ...
            if (day == "Monday" || day == "Tuesday" || day == "Wednesday" || day == "Thursday" || day == "Friday")
            {
                ...
                if (hour == 6 || hour >= 6)
                    Console.WriteLine($"It is {day} {hour} O' clock and it's time to wake up and get ready for the work day");
                // This code here validates if its not 6:00am or early than 6:00am in the week from monday to friday.
                else if (hour != 6 || hour <= 6)
                    Console.WriteLine($"It is {day} {hour} O' clock and it's not time to get up yet");   
                else
                    Console.WriteLine($"It is {day} {hour} O' clock and it's not time to get up, go back to sleep");
            }
            ...
            else if (day == "Saturday" || day == "Sunday")
            {
                ...
                if (hour == 9 || hour >= 9)
                    Console.WriteLine($"It is {day} {hour} O' clock and it's is the weekend and it is time to wake up and enjoy the day");
                //This code here validates if its not 9:00am or early than 9:00am in the week from monday to friday.
